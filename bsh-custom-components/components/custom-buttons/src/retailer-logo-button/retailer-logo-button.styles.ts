...
import { createMarginStyles, createPaddingStyles, createBorderStyle, createFontStyle } from "../../../helpers/helpers";

export const retailerLogoButtonStyle: Styles<
  "container" | "heading" | "dealerLogos" | "dealerInfo" | "dealerLogo" | "arrow" | "policyText"
> = {
  ...
  dealerInfo: ({ logoBorder, verticalMargin, horizontalMargin, logoPadding }: RetailerLogosConfiguration) => ({
  ...
  arrow: ({ arrowColor, arrowRightPadding, iconSize }: RetailerLogosConfiguration) => ({
