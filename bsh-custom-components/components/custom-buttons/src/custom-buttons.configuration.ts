...
class ConfiguratorCombinableProductsButtonConfiguration {
  public backgroundColor = "";
  public font: FontWithTextDecorationAndAlignConfiguration = new FontWithTextDecorationAndAlignConfiguration();
  public border: BorderConfiguration = new BorderConfiguration();
...
export class BuyOnlineButtonConfiguration {
  ...
  buyOnlineOverlay: BuyOnlineOverlayConfiguration = new BuyOnlineOverlayConfiguration();
}
...
export class CombinableProductsButtonConfiguration {
  ...
  margin: MarginConfiguration = new MarginConfiguration();
  padding: PaddingConfiguration = new PaddingConfiguration();
  size: SizeValuesConfiguration = new CombinableProductsSizeValuesConfiguration();
}

export class RetailerLogosConfiguration {
  retailerLogosPrivacyPolicyUrl = "/dealer-locator/dealer_locator_privacy_policy";
...
export class CustomButtonsConfiguration {
  buyOnlineButton: BuyOnlineButtonConfiguration = new BuyOnlineButtonConfiguration();
  dealerLocatorButton: DealerLocatorButtonConfiguration = new DealerLocatorButtonConfiguration();
  combinableProductsButton: CombinableProductsButtonConfiguration = new CombinableProductsButtonConfiguration();
  retailerLogoButton: RetailerLogosConfiguration = new RetailerLogosConfiguration();
}
