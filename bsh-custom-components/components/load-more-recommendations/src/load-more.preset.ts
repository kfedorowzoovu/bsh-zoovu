    ...
    object(
        {
            ...
            buttonLabel: standardText({ default: "Lore More", label: "Load more button text" }),
            buttonLabelAfterClicked: standardText({ default: "Load Less", label: "Load less button text" }),
        },
