...
export const infoTextModalStyles: Styles<
  InfoTextStyleNames,
  InfoTextModalConfiguration
> = {
  container: ({ popupSize }) => ({
    alignItems: 'center',
    display: 'flex',
  ...
  modalClose: {
    ...
    backgroundImage:
      'url(http://d3smx8fpgq4j0l.cloudfront.net/zoovu/674e4ba4-7bc1-4a09-bfe9-3f976d460bab)',
